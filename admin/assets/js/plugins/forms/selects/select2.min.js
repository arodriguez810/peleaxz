    ...
    var b = function () {
        ...
        return function () {
            ...
            return b.Extend(c, b.Observable), c.prototype.render = function () {
                ...
                this.data.current(function (c) {
                    ...
                    e.each(function () {
                        ...
                        null != c.element && c.element.selected || null == c.element && a.inArray(e, d) > -1 ? b.attr("aria-selected", "true").addClass('bg-' + COLOR.primary) : b.attr("aria-selected", "false").removeClass('bg-' + COLOR.primary)
                    })
                })
            ...
            return c.Extend(d, b), d.prototype.render = function () {
                ...
                var b = a('<li class="select2-selection__choice ' + ('bg-' + COLOR.primary) + '"><span class="select2-selection__choice__remove" role="presentation">&times;</span></li>');
                return b
            }, d.prototype.update = function (a) {
