...
!function (e) {
    ...
    return i.prototype = {
        _init: function () {
                ...
                case a.EVENT.TOOLTIP_OUT_GRID:
                    if (t) {
                        ...
                        o && this._zr.trigger("mousemove", {
                            connectTrigger: !0,
                            zrenderX: osetOption.getX() + e.x * o.getWidth(),
            ...
            var retured = e.timeline ? this._setTimelineOption(e) : this._setOption(e, t)

            return retured;
        }, _setOption: function (e, t, i) {

            var returned2 =  (!t && this._option ? this._option = o.merge(
                this.getOption(), o.clone(e), !0) : (this._option = o.clone(e), !i && this._timeline && this._timeline.dispose()),
