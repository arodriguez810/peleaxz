...
!function (t, e) {
    ...
    return a.prototype = {
        constructor: a, setStartDate: function (e) {
            ...
            this.renderCalendar("left"), this.renderCalendar("right"), this.container.find(".ranges li").removeClass("active").removeClass("bg-" + COLOR.primary), null != this.endDate && this.calculateChosenLabel()
            ...
            for (b = 0; b < 6; b++) {
                ...
                for (k = 0; k < 7; k++) {
                    var O = [];
                    i[b][k].isSame(new Date, "day") && O.push("today"), i[b][k].isoWeekday() > 5 && O.push("weekend"), i[b][k].month() != i[1][1].month() && O.push("off", "ends"), this.minDate && i[b][k].isBefore(this.minDate, "day") && O.push("off", "disabled"), C && i[b][k].isAfter(C, "day") && O.push("off", "disabled"), this.isInvalidDate(i[b][k]) && O.push("off", "disabled"), i[b][k].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && O.push("active bg-" + COLOR.primary, "start-date"), null != this.endDate && i[b][k].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && O.push("active bg-" + COLOR.primary, "end-date"), null != this.endDate && i[b][k] > this.startDate && i[b][k] < this.endDate && O.push("in-range");
            ...
            for (var a in this.ranges) {
                if (this.timePicker) {
                    ...
                    if (this.startDate.format(i) == this.ranges[a][0].format(i) && this.endDate.format(i) == this.ranges[a][1].format(i)) {
                        t = !1, this.chosenLabel = this.container.find(".ranges li:eq(" + e + ")").addClass("active bg-" + COLOR.primary).attr("data-range-key");
                        break
                    }
            ...
            t && (this.showCustomRangeLabel ? this.chosenLabel = this.container.find(".ranges li:last").addClass("active bg-" + COLOR.primary + " ").attr("data-range-key") : this.chosenLabel = null, this.showCalendars())
